...
<div class="space-y-3 rounded-lg border bg-white p-3 shadow-sm dark:border-dark-border dark:bg-dark-surface dark:shadow-none">
	<div class="flex items-center gap-2">
		<h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Controls</h2>
		<div class="group relative">
			<button
				type="button"
				class="inline-flex h-5 w-5 items-center justify-center rounded-full border border-gray-300 text-[11px] font-semibold text-gray-500 hover:border-blue-500 hover:text-blue-600 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-dark-border dark:text-gray-400"
			...
			<div
				class="pointer-events-none absolute left-0 z-10 mt-2 hidden w-64 rounded-md border border-gray-200 bg-white p-2 text-xs leading-5 text-gray-600 shadow-lg group-focus-within:block group-hover:block dark:border-dark-border dark:bg-dark-subtle dark:text-gray-400"
				role="tooltip"
			>
				{navigationTip}
			</div>
	...
	<div class="flex flex-wrap items-center gap-3">
		...
		<div class="hidden h-6 w-px bg-gray-200 sm:block dark:bg-dark-border" aria-hidden="true"></div>

		<div
			class="relative inline-grid min-w-[17rem] grid-cols-4 rounded-md border border-gray-200 bg-gray-50 p-1 dark:border-dark-border dark:bg-dark-subtle"
		>
			<div
			...
			{#each groupByOptions as option (option.value)}
				...
				<div class="group relative flex">
					...
					{#if disabledReason}
						<div
							class="pointer-events-none absolute top-full left-1/2 z-20 mt-1 hidden w-44 -translate-x-1/2 rounded-md border border-gray-200 bg-white p-2 text-xs leading-4 text-gray-600 shadow-lg group-focus-within:block group-hover:block dark:border-dark-border dark:bg-dark-subtle dark:text-gray-400"
							role="tooltip"
						>
							{disabledReason}
						</div>
