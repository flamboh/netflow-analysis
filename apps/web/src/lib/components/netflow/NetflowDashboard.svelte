...
<div class="rounded-lg border bg-white shadow-sm dark:border-dark-border dark:bg-dark-surface dark:shadow-none">
	<div
	...
	<div class="space-y-4 p-4">
		...
		<div
			class="h-[320px] min-h-[240px] resize-y overflow-auto rounded-md border border-gray-200 bg-white/60 dark:border-dark-border dark:bg-dark-subtle/60"
		>
			{#if loading}
				<div class="flex h-full items-center justify-center">
					<div class="flex items-center gap-3 text-gray-500 dark:text-gray-400">
						<div
							class="h-5 w-5 animate-spin rounded-full border-2 border-gray-300 border-t-gray-500 dark:border-dark-border dark:border-t-gray-400"
							aria-hidden="true"
						></div>
			...
			{:else if results.length === 0}
				<div class="flex h-full items-center justify-center">
					<div class="text-gray-500 dark:text-gray-400">No data available for the selected filters</div>
				</div>
			{:else}
				<ChartContainer
					{results}
