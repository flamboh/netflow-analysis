...
<div class="mx-auto max-w-[90vw] px-2 py-2 sm:px-2 lg:px-4">
	...
	<div class="mb-2 rounded-lg border bg-blue-100 p-4 dark:border-dark-border dark:bg-dark-subtle">
	...
	{#if summaryError}
		<div class="rounded-lg border border-red-200 bg-red-50 p-4 text-red-700 dark:border-red-900 dark:bg-red-950 dark:text-red-400">
	...
	{:else if summaryLoading && summarySkeletonVisible}
		<div class="space-y-2">
			{#each summarySkeletons as skeletonId (skeletonId)}
				<div class="animate-pulse rounded-lg border bg-white shadow-sm dark:border-dark-border dark:bg-dark-surface">
					<div class="bg-cisco-blue rounded-t-lg p-4 dark:bg-dark-subtle">
					...
					<div class="space-y-4 p-4">
						<div class="h-6 w-36 rounded bg-gray-200 dark:bg-dark-border"></div>
						<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
							<div class="space-y-3">
								<div class="h-5 w-44 rounded bg-gray-200 dark:bg-dark-border"></div>
								<div class="h-4 w-96 max-w-full rounded bg-gray-100 dark:bg-dark-subtle"></div>
								<div class="h-96 rounded bg-gray-100 dark:bg-dark-subtle"></div>
							</div>
							<div class="space-y-3">
								<div class="h-5 w-52 rounded bg-gray-200 dark:bg-dark-border"></div>
								<div class="h-4 w-96 max-w-full rounded bg-gray-100 dark:bg-dark-subtle"></div>
								<div class="h-96 rounded bg-gray-100 dark:bg-dark-subtle"></div>
							</div>
						</div>
						...
						<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
							<div class="space-y-3">
								<div class="h-5 w-48 rounded bg-gray-200 dark:bg-dark-border"></div>
								<div class="h-56 rounded bg-gray-100 dark:bg-dark-subtle"></div>
							</div>
							<div class="space-y-3">
								<div class="h-5 w-56 rounded bg-gray-200 dark:bg-dark-border"></div>
								<div class="h-56 rounded bg-gray-100 dark:bg-dark-subtle"></div>
							</div>
						</div>
					</div>
	...
	{:else if summaryLoading}
		<div class="rounded-lg border bg-white p-4 text-gray-600 shadow-sm dark:border-dark-border dark:bg-dark-surface dark:text-gray-400">
				...
				<div class="rounded-lg border bg-white shadow-sm dark:border-dark-border dark:bg-dark-surface">
					...
					<div class="rounded-b-lg p-4">
						{#if record.file_exists_on_disk === false}
							<div class="mb-4 rounded-lg border border-amber-300 bg-amber-50 p-4 text-amber-900 dark:border-amber-700 dark:bg-amber-950 dark:text-amber-300">
						...
						<div class="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
							<h5 class="hidden border-b pb-2 text-base font-semibold text-blue-700 dark:border-dark-border dark:text-blue-400 lg:block">
								Source
							</h5>
							<h5 class="hidden border-b pb-2 text-base font-semibold text-blue-700 dark:border-dark-border dark:text-blue-400 lg:block">
								Destination
								...
								<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
									<div>
										...
										{:else if errorsSource.get(record.router)}
											<div class="rounded border border-red-200 bg-red-50 p-4 text-red-700 dark:border-red-900 dark:bg-red-950 dark:text-red-400">
										...
										{:else if structureFunctionDataSource.get(record.router)}
											...
											/>
										{:else}
											<div class="rounded border bg-gray-50 p-4 text-gray-600 dark:border-dark-border dark:bg-dark-subtle dark:text-gray-400">
								...
								<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
									<div>
										...
										{:else if errorsSingularitiesSource.get(record.router)}
											<div class="rounded-lg border border-red-300 bg-red-50 p-4 dark:border-red-900 dark:bg-red-950">
